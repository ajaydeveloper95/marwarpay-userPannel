...
//   const [totalBalance, setTotalBalance] = useState(0); // Track the total balance across all pages
...
//       // Track totalDocs, total balance, and total pages (if available from response)
//       setTotalDocs(response.data.totalDocs || 0);
//       setTotalBalance(response.data.totalBalance || 0); // Assuming the API provides this value
//       setTotalPages(Math.ceil(response.data.totalDocs / itemsPerPage)); // Calculate total pages
...
//               <CardContent>
//                 <Typography variant="h6" component="div">Total Balance</Typography>
//                 <Typography variant="h4" component="div" sx={{ mt: 1, color: '#4caf50' }}>
//                   ₹{Number(totalBalance).toFixed(2)} {/* Display total balance for all data */}
//                 </Typography>
//               </CardContent>
//             </Card>
//           </Grid>
...
//                   {totalDocs} {/* Display total number of transactions across all pages */}
//                 </Typography>
//               </CardContent>
//             </Card>
//           </Grid>
...
//               filteredData.map((trx, index) => (
//                 <TableRow key={index}>
//                   <TableCell align="center" sx={{ border: '1px solid #ddd', whiteSpace: 'nowrap', padding: '8px' }}>
//                     {index + 1 + (currentPage - 1) * itemsPerPage}
//                   </TableCell>
//                   <TableCell align="center" sx={{ border: '1px solid #ddd', whiteSpace: 'nowrap', padding: '8px', color: trx.transactionType === 'Cr.' ? 'green' : trx.transactionType === 'Dr.' ? 'red' : 'inherit' }}>
//                     {trx.transactionType}
//                   </TableCell>
//                   <TableCell align="center" sx={{ border: '1px solid #ddd', whiteSpace: 'nowrap', padding: '8px' }}>{trx.transactionAmount}</TableCell>
//                   <TableCell align="center" sx={{ border: '1px solid #ddd', whiteSpace: 'nowrap', padding: '8px' }}>{trx.beforeAmount}</TableCell>
//                   <TableCell align="center" sx={{ border: '1px solid #ddd', whiteSpace: 'nowrap', padding: '8px' }}>{trx.afterAmount}</TableCell>
//                   <TableCell align="center" sx={{ border: '1px solid #ddd', whiteSpace: 'nowrap', padding: '8px', color: trx.transactionStatus === 'Success' ? 'green' : 'red' }}>
